...
def main():
    res_url = requests.get(
        "https://52.79.128.1:8080/marketAll", verify=False)
    ...
    user_url = requests.get(
        "https://52.79.128.1:8080/userAll", verify=False)
    ...
    review_url = requests.get(
        "https://52.79.128.1:8080/reviewAll", verify=False)
    ...
    location_url = requests.get(
        "https://52.79.128.1:8080/mapAll"+str(ID_INPUT), verify=False)
